<template>
  <div
    v-if="show" id="default-modal" tabindex="-1" aria-hidden="true"
      ...
      <div class="relative bg-white rounded-lg shadow">
        ...
        <div class="pb-4 md:p-5 space-y-2 h-12">
          <p class="text-gray-600 dark:text-gray-400 text-center">
            Apakah Anda yakin ingin mengganti timer?
          </p>
        </div>
        <!-- Footer Modal -->
        <div class="px-4 bg-gray-50 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
          <button
            type="button"
            class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-gray-300 text-base font-medium text-white hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 sm:ml-3 sm:w-auto sm:text-sm"
            @click="closeModal">
            TIDAK
          </button>
          <button
