<template>
  <footer id="footer" class="max-w-screen-xl px-8 mx-auto">
      ...
      <div class="grid xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1">
        ...
        >
          ...
          <div class="flex items-center space-x-2">
            ...
            />
            <button class="bg-gradient-to-r from-yellow-500 to-yellow-300 px-4 py-4 sm:py-3 rounded-md text-white hover:shadow-md transition duration-300">
    ...
    <div class="py-8 sm:py-4 text-center text-sm text-[#666666] hover:text-gray-900">
      &copy; Copyright 2024 TimeMinder. All rights reserved
    </div>
  </footer>
</template>
<script>
